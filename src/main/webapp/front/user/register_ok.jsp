	...
	<body>
		...
		<div class="login_success">
			<div class="login_bj">
				...
				<h5>
					${ sessionScope.loginUser.user_nickname }，欢迎加入当当网
				</h5>
				<h6>
					请牢记您的登录邮件地址：${ sessionScope.loginUser.user_email }
				</h6>
				...
				<ul>
					...
					<li>
						<a href="${ pageContext.request.contextPath }/show/showMainAction">浏览并选购商品</a>
					</li>
				</ul>
			</div>
		</div>
